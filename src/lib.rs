...
#[derive(Debug)]
pub struct PrimaryIDProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimaryIDProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimaryID processing");
    
    let mut processor = PrimaryIDProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimaryIDProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimaryIDProcessor::new(false);
